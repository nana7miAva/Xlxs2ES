...
public class bTrackListener extends AnalysisEventListener<bTrack> {


    private String caseID;
    private RestHighLevelClient restHighLevelClient;

    public bTrackListener(String caseID, RestHighLevelClient restHighLevelClient) {
        this.caseID = caseID;
    ...
    @SneakyThrows
    @Override
    public void invoke(bTrack bTrack, AnalysisContext analysisContext) {

        JSONObject toJSON = (JSONObject) JSONObject.toJSON(bTrack);
